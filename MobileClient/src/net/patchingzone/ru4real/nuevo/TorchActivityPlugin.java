 ...
 */
public class TorchActivityPlugin extends FragmentActivity {

	private static final String TAG = TorchActivityPlugin.class.getSimpleName();
	...
	private static TorchActivityPlugin torch;

	public TorchActivityPlugin() {
		super();
		torch = this;
	}

	public static TorchActivityPlugin getTorch() {
		return torch;
	}
